					...
					<div class='flex flex-wrap -m-4'>
						{products &&
							products.map((pr, index) => (
								<div
									class=' card-header p-4 md:w-1/3'
									key={index}>
									<div class=' product h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
										<img
										...
										/>
										<div class='p-6'>
											<h2 class='tracking-widest text-xs title-font font-medium text-black-400 mb-1'>
												{pr.category}
											</h2>
											...
											<div class=' flex items-center flex-wrap '>
												<a class='text-red-500 inline-flex items-center md:mb-2 lg:mb-0'>
													<button class=' card-footer' onClick={() => dispatch(addCart(pr))}>
														Add to cart
													</button>
												</a>
											</div>
